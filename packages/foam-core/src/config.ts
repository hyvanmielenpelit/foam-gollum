export interface IFoamConfig {
  ...
  // Wikilinks (Gollum)
  getWikilinksSyntax(): 'mediawiki' | 'gollum';
  getWikilinksCaseInsensitive(): boolean;
...
export function cascadeFoamConfig(
  ...
  return {
    ...
    getWikilinksSyntax: () => get('getWikilinksSyntax'),
    getWikilinksCaseInsensitive: () => get('getWikilinksCaseInsensitive'),
...
export class DefaultFoamConfig implements IFoamConfig {
  ...
  getWikilinksSyntax(): 'mediawiki' | 'gollum' { return 'mediawiki'; }
  getWikilinksCaseInsensitive() { return false; }
...
export class Config {
  ...
  static getWikilinksSyntax(): 'mediawiki' | 'gollum' { return Config.defaultConfig.getWikilinksSyntax(); }
  static getWikilinksCaseInsensitive(): boolean { return Config.defaultConfig.getWikilinksCaseInsensitive(); }
